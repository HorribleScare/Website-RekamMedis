...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
	...
	<a href="<?= $main_url ?>obat/tambah-obat.php" class="btn btn-outline-secondary btn-sm mb-3"
	title="tambah obat baru"><i class="bi bi-plus-lg align-top"></i> Obat Baru</a>
			...
			while($obat = mysqli_fetch_assoc($queryObat)){ ?>
				<tr>
					...
					<td>
						...
						<i class="bi bi-pen align-top"></i></a>
						
						<a href="proses-obat.php?id=<?= $obat['id'] ?>&aksi=hapus-obat"
						onclick="return confirm('Apakah Anda yakin ingin menghapus data obat ini ?')"
						class="btn btn-sm btn-outline-danger" title="hapus obat"><i class="bi bi-trash align-top"></i></a>
					</td>
				</tr>
			<?php } ?>
		</tbody>
