...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
	...
	<a href="<?= $main_url ?>pasien/tambah-pasien.php" class="btn btn-outline-secondary btn-sm mb-3"
	title="tambah pasien baru"><i class="bi bi-plus-lg align-top"></i> Pasien Baru</a>
			...
			while($pasien 	= mysqli_fetch_assoc($queryPasien)){ ?>
				<tr>
					...
					<td>
						...
						class="btn btn-sm btn-outline-danger" title="hapus pasien"><i class="bi bi-trash align-top"></i></a>
					</td>
				</tr>
			<?php } ?>
		</tbody>
