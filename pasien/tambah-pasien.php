	...
	<form action="proses-pasien.php" method="post">
		<div class="row">
			<div class="col-lg-8">
				...
				<div class="form-group mb-3">
					<label for="telpon" class="form-label">Telepon / HP</label>
					<input type="tel" name="telpon" class="form-control" id="telpon" placeholder="Telepon Pasien"
					pattern="[0-9]{8,}" title="Minimal 8 angka" required>
				</div>
				
				<div class="form-group mb-3">
					<label for="alamat" class="form-label">Alamat</label>
					<textarea name="alamat" id="alamat" cols="" rows="" class="form-control"
					placeholder="Alamat Pasien" required></textarea>
				</div>
