		...
		<div class="row">
			<div class="col-lg-4 mb-4 text-center">
				<div class="px-4 mb-4">
					...
					<span class="text-sm">Format file gambar JPG | PNG | GIF</span><br>
			...
			<div class="col-lg-8">
				...
				<div class="form-group mb-3">
					...
					value="<?= $user['fullname'] ?>" placeholder="Masukkan Nama Lengkap User" required>
				</div>
				...
				<div class="form-group mb-3">
					...
					<textarea name="alamat" id="alamat" cols="" rows="3" class="form-control" placeholder="Masukkan Alamat User">
