...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
	...
	<a href="<?= $main_url ?>user/tambah-user.php" class="btn btn-outline-secondary btn-sm mb-3"
			...
			?>
				<tr>
					...
					<td>
						...
						<a href="proses-user.php?id=<?= $user['userid'] ?>&gambar=<?= $user['gambar'] ?>&aksi=hapus-user"
