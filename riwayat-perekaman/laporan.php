...
$gender 		= ($pasien['gender'] == 'P') ? 'Pria' : 'Wanita';
...
<body>
	...
	<table>
		...
		<tr>
			...
			<th class="label-head">Telepon</th>
	...
	<table>
		...
		<tbody>';
			$sqlrm = "SELECT * FROM tbl_rekamedis INNER JOIN tbl_user ON
			tbl_rekamedis.id_dokter = tbl_user.userid WHERE id_pasien = '$id' ";
...
$dompdf->render();
$dompdf->stream('Laporan Rekam Medis', ['Attachment' => false]);
