...
if($msg == 'added'){
	...
	<strong><i class="bi bi-bag-check-fill align-top"></i> Tambah data rekam medis berhasil !</strong>
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
		<h1 class="h2">Data Perekaman Baru</h1>
		...
		<?php if($msg !== ''){
			...
			<div class="col-lg-6 pe-4">
				...
				<div class="form-group mb-3">
					...
					<textarea name="keluhan" id="keluhan" class="form-control" placeholder="Keluhan Pasien Tentang Penyakitnya" rows="1"></textarea>
				</div>
			</div>
			...
			<div class="col-lg-6 border-start ps-4">
				...
				<button type="reset" class="btn btn-outline-danger btn-sm"><i class="bi bi-x-lg align-top"></i> Atur Ulang</button>
